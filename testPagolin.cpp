...
int test_pagolin( cv::Mat &img )
{
	...
	pangolin::OpenGlRenderState s_cam(proj, pangolin::ModelViewLookAt(1,0.5,-2,0,0,0, pangolin::AxisZ) );
...
//		imageTexture.RenderToViewport();
		...
		d_img1.Activate();
//		cv::Mat disp_img;
//		cv::resize(img,disp_img, cv::Size(width, height));
